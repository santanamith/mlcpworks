 ...
 * 
 */
public class ConexionBDMelanio {
    private Connection con;
    private Statement  sentSQL;
    private ResultSet rst;


    public ConexionBDMelanio() throws ClassNotFoundException,SQLException,InstantiationException,IllegalAccessException{
    ...
    String URL_bd="jdbc:sqlserver://CIBERT_POET\\CIBERT_POET;databaseName=PHARMACY_MERHY";
    String usuario="poeta";
